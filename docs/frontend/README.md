...
跪了，难受，最后面试官随便问了点问题，不过估计我是挂了的。

吐槽：结果腾讯总共三面竟然一点vue/react，浏览器渲染，本地存储，设计模式，事件循环之类的知识都没问..



##### 阿里 钉钉 一面

> 问了很多深层次的原理，晚一点详细展开做个笔记。
...
4. 单页应用和多页应用的优缺点对比，单页应用的好处，单页应用的SEO问题如何解决。服务端渲染和同构（没回答上来）
